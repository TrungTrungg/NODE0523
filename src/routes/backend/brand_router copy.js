...
const upload = multer({ dest: './public/uploads/brand' });
...
// Thêm 1 Item
router.post('/', upload.single('image'), validator.brandFormValidate, controller.addOne);
...
// Sửa 1 Item
router.post('/edit', upload.single('image'), validator.brandFormValidate, controller.editOne);
