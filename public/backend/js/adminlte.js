...
(function (global, factory) {
    ...
    var CardWidget = /*#__PURE__*/ (function () {
        ...
        CardWidget._jQueryInterface = function _jQueryInterface(config) {
            ...
            if (
                ...
                /collapse|expand|remove|toggle|maximize|minimize|toggleMaximize/.test(config)
            ) {
                data[config]();
    ...
    var ControlSidebar = /*#__PURE__*/ (function () {
        ...
        _proto.toggle = function toggle() {
            ...
            var shouldClose =
                $body.hasClass(CLASS_NAME_CONTROL_SIDEBAR_OPEN$1) || $body.hasClass(CLASS_NAME_CONTROL_SIDEBAR_SLIDE);
            var shouldToggle =
                notVisible &&
                ($body.hasClass(CLASS_NAME_CONTROL_SIDEBAR_OPEN$1) || $body.hasClass(CLASS_NAME_CONTROL_SIDEBAR_SLIDE));
        ...
        _proto._fixScrollHeight = function _fixScrollHeight() {
            ...
            var navbarFixed =
                this._isNavbarFixed() && $__default['default'](SELECTOR_HEADER$1).css('position') === 'fixed';
            var footerFixed =
                this._isFooterFixed() && $__default['default'](SELECTOR_FOOTER$1).css('position') === 'fixed';
            var $controlsidebarContent = $__default['default'](
                this._config.target + ', ' + this._config.target + ' ' + SELECTOR_CONTROL_SIDEBAR_CONTENT$1,
            );
    ...
    var IFrame = /*#__PURE__*/ (function () {
        ...
        _proto.openTabSidebar = function openTabSidebar(item, autoOpen) {
            ...
            if (
                (!this._config.allowDuplicates && $__default['default']('#' + navId).length === 0) ||
        ...
        _proto.removeActiveTab = function removeActiveTab(type, element) {
            if (type == 'all') {
                ...
                if (
                    ...
                    $__default['default'](SELECTOR_TAB_EMPTY + ', ' + SELECTOR_TAB_LOADING).length
                ) {
                    $__default['default'](SELECTOR_TAB_EMPTY).show();
                } else {
        ...
        _proto._setupListeners = function _setupListeners() {
            ...
            $__default['default'](document).on('click', SELECTOR_DATA_TOGGLE_CLOSE, function (e) {
                ...
                _this3.removeActiveTab(
                    target.attributes['data-type'] ? target.attributes['data-type'].nodeValue : null,
                    target,
                );
            });
        ...
        _proto._setItemActive = function _setItemActive(href) {
            $__default['default'](SELECTOR_SIDEBAR_MENU_ITEM + ', ' + SELECTOR_HEADER_DROPDOWN_ITEM).removeClass(
                'active',
            );
        ...
        _proto._fixHeight = function _fixHeight(tabEmpty) {
            ...
            if ($__default['default']('body').hasClass(CLASS_NAME_FULLSCREEN_MODE)) {
                ...
                $__default['default'](
                    SELECTOR_TAB_EMPTY + ', ' + SELECTOR_TAB_LOADING + ', ' + SELECTOR_CONTENT_IFRAME,
                ...
                if (tabEmpty == true) {
                    setTimeout(function () {
                        $__default['default'](SELECTOR_TAB_EMPTY + ', ' + SELECTOR_TAB_LOADING).height(
            ...
            if (endResults.length === 0) {
                ...
                endResults.each(function (i, result) {
                    $__default['default'](SELECTOR_SEARCH_RESULTS_GROUP).append(
                        _this2._renderItem(escape(result.name), encodeURI(result.link), result.path),
                    );
                });
            }
