...
(function () {
    function w(a, c) {
        ...
        if (!a[0]?.opt.fallbacks.disableFocusListener)
            m(window).on('focus.rsaddonbeforeafter', this.onFocus.bind(this));
        a.one('revolution.slide.onloaded', this.onLoaded.bind(this)).one(
            'rsBeforeAfterDestroyed',
    ...
    function t(a, c, b, e, g, h, k, d, f, p, n, q, l, r) {
        ...
        this.timing = 0.001 * parseInt(d.time, 10);
        this.delay = 0.001 * parseInt(d.delay, 10);
        a = d.easing.split('.');
        this.animation = punchgs[a[0]][a[1]];
        'horizontal' === this.direction
            ? ((this.normal = !0), (this.axis = 'left'), (this.size = 'width'))
            : ((this.axis = 'top'), (this.size = 'height'));
        this.globals.hasOwnProperty('onClick') &&
            ((a = this.globals.onClick.easing.split('.')),
            (this.time = 0.001 * parseInt(this.globals.onClick.time, 10)),
        ...
        d.hasOwnProperty('bounceArrows') &&
            ((this.bounceArrows = d.bounceArrows),
            (this.bounceDelay = parseInt(d.bounceDelay, 10)),
            (this.readyArrows = this.arrowsReady.bind(this)),
            this.bounceDelay && (this.delayBounce = this.bounceReady.bind(this)));
        d.hasOwnProperty('shiftOffset') && (this.shiftArrows = d.shiftOffset);
        this.videoBg && !this.videoSolo && (this.videoPlay = this.playVideo.bind(this));
        this.createDrag();
    ...
    window.RevSliderBeforeAfter = function (a, c, b) {
        a &&
            ...
            ((m = a),
            (m.event.special.rsBeforeAfterDestroyed = {
                remove: function (a) {
                    a.handler();
                },
            }),
    ...
    w.prototype = {
        init: function () {
            ...
            this.slider
                .addClass('rs-before-after-addon')
        ...
        onLoaded: function () {
            ...
            this.slider
                .data('before-after-placer', b)
                .data('beforeafter-slides')
                .each(function () {
                    var b = m(this),
                        g = b
                            .find('.tp-caption[data-beforeafter="before"]')
                            .toArray()
                            .map(function (a) {
                                return m(a).closest('.tp-parallax-wrap');
                            }),
                        h = b
                            .find('.tp-caption[data-beforeafter="after"]')
                            .toArray()
                            .map(function (a) {
                                return m(a).closest('.tp-parallax-wrap');
                            }),
                    ...
                    1 < g.length ? d.insertAfter(b.find('.tp-parallax-wrap').last()) : d.appendTo(b);
                    var g = m('<div class="rs-addon-beforeafter-revealer rs-addon-beforeafter-after" />'),
                        ...
                        n = k.bgType;
                    if ('image' === n || 'external' === n)
                        (f.style.backgroundImage = 'url(' + k.bgImage + ')'),
                            (f.style.backgroundPosition = k.bgPos),
                            (f.style.backgroundRepeat = k.bgRepeat),
                            (f.style.backgroundSize = k.bgFit);
                    else if ('solid' === n) f.style.background = k.bgColor;
                    else if (
                        'trans' !== n &&
                        (n = b.data('beforeafter-video')) &&
                    ...
                    b.attr('data-link') &&
                        'back' === b.attr('data-slideindex') &&
                        (d.addClass('rs-beforeafter-pointers'), g.addClass('rs-beforeafter-pointers'));
                    ...
                    a.slides[a.slides.length] = new t(
                        c,
                        p,
                        h,
                        b,
        ...
        beforeSwap: function (a, c) {
            if (!this.checkRemoved()) {
                this.slide = !1;
                var b;
                c.currentslide.length &&
                    (b = m.data(c.currentslide[0], 'rs-addon-beforeafter')) &&
                    (b.removeEvents(), b[b.animateOut]());
                (b = m.data(c.nextslide[0], 'rs-addon-beforeafter')) && b.setup && b.reset();
            }
        },
        afterSwap: function (a, c) {
            !this.checkRemoved() &&
                c.currentslide.hasClass('rs-addon-beforeafter') &&
                ((this.slide = m.data(c.currentslide[0], 'rs-addon-beforeafter')),
                this.slide.setup ||
                    (this.onResize(!1, !0),
                    this.slide.onSetup(),
        ...
        destroy: function () {
            ...
            if (this.slides) for (; this.slides.length; ) this.slides[0].destroy(), this.slides.shift();
        ...
        onResize: function (a, c) {
            if (a && this.carousel) clearTimeout(this.resizeTimer), (this.resizeTimer = setTimeout(this.resize, 250));
                ...
                if (b) {
                    ...
                    c ||
                        (punchgs.TweenLite.killTweensOf(b.bg),
                        punchgs.TweenLite.killTweensOf(b.after),
                        punchgs.TweenLite.killTweensOf(b.before),
                        punchgs.TweenLite.killTweensOf(b.revealBtn),
                        b.revealLine && punchgs.TweenLite.killTweensOf(b.revealLine));
                    for (var h = k / this.widths[g], f = this.slides.length; f--; )
                        (e = this.slides[f]),
                            (e.level = g),
                            (e.scale = h),
                            (e.blurred = !1),
                            ...
                            (e.sliderHeight = d),
                            e.normal
                                ? ((e.bgInner.style.width = k + 'px'), (e.inner.style.width = k + 'px'))
                                : ((e.bgInner.style.height = d + 'px'), (e.inner.style.height = d + 'px'));
                    c ||
                        (b.normal
                            ? ((k = b.moveto[b.level]),
                              -1 === k.search('%') && (k = (parseInt(k, 10) * h).toFixed(0) + 'px'),
                              (d = '50%'))
                            : ((k = '50%'),
                              (d = b.moveto[b.level]),
                              -1 === d.search('%') && (d = (parseInt(d, 10) * h).toFixed(0) + 'px')),
                        b.resetDrag(k, d));
                }
            }
        },
    ...
    t.prototype = {
        createDrag: function () {
            var a = this.globals,
                ...
                a =
                    '<span class="rs-addon-beforeafter-btn rs-before-after-element rs-addon-beforeafter-btn-' +
                    this.direction +
                    '" style="color: ' +
                    b.color +
                    ';font-size: ' +
            ...
            var f,
                ...
                n = (f = ''),
                q = '',
                l = this.shiftArrows ? ' rs-' + this.id + '-' + this.index + '-rs-beforeafter-shift' : '';
            this.normal
                ? ((e = 'padding-right'),
                  (g = 'padding-left'),
                  (c = b.leftIcon),
                  (b = b.rightIcon),
                  this.bounceArrows &&
                      ((f = ' rs-' + this.id + '-' + this.index + '-rs-beforeafter-bounce-'),
                      (p = f + 'left'),
                      (f += 'right')),
                  this.shiftArrows &&
                      ((n = 'transform: translateX(-' + this.shiftArrows + 'px);'),
                      (q = 'transform: translateX(' + this.shiftArrows + 'px);')))
                : ((e = 'margin-bottom'),
                  (g = 'margin-top'),
                  (c = b.topIcon),
                  (b = b.bottomIcon),
                  this.bounceArrows &&
                      ...
                      (f += 'bottom')),
                  this.shiftArrows &&
                      ((n = 'transform: translateY(-' + this.shiftArrows + 'px);'),
                      (q = 'transform: translateY(' + this.shiftArrows + 'px);')));
            a += '" />';
            ...
            d &&
                ((h =
                    '<span class="rs-addon-beforeafter-line rs-before-after-element rs-beforeafter-' +
                    this.direction +
                    '" style="' +
                    this.size +
                    ': ' +
                    d +
                    'px; ' +
                    (this.normal ? 'margin-left: ' : 'margin-top: ') +
                    -Math.floor(0.5 * d) +
                    'px; background-color: ' +
                    h.color),
                k &&
                    (h +=
                        ...
                        parseInt(k.blur, 10) +
                        'px ' +
                        parseInt(k.strength, 10) +
                        'px ' +
                        k.color +
                        ';'),
                (this.revealLine = m(h + '"></span>')[0]),
                (this.pixel = 0 === d % 2 ? 0 : 1),
                (a[0] = this.revealLine));
        ...
        onSetup: function () {
            ...
            var e = Math.floor(0.5 * a);
            this.buffer = e;
            this.setup = !0;
            this.btn.css({ width: a, height: a, marginTop: -e + b, marginLeft: -e + c });
            delete this.btn;
        },
        addEvents: function () {
            var a = this.carousel ? this.slide : this.slider;
            a.on(
                'mouseup.rsaddonbeforeafter mouseleave.rsaddonbeforeafter touchend.rsaddonbeforeafter',
                this.mouseUp,
            ).on('mousemove.rsaddonbeforeafter touchmove.rsaddonbeforeafter', this.mouseMove);
            if (this.transition) a.on('click.rsaddonbeforeafter', this.mouseClick);
        },
        ...
        updateDrag: function (a, c) {
            if (this.before) {
                if (this.normal) {
                    ...
                    (b = c),
                        (e = this.sliderHeight - c),
                        (a = Math.min(this.sliderWidth - this.buffer, Math.max(a, this.buffer)));
                this.revealBtn.style.left = a + 'px';
        ...
        resetDrag: function (a, c) {
            if (this.before) {
                if (this.normal) {
                    ...
                    (b = c),
                        (e = parseInt(c, 10)),
                        (e = -1 !== c.search('%') ? 100 - e + '%' : this.sliderHeight - e + 'px');
                this.revealBtn.style.left = a;
                this.revealBtn.style.top = c;
                this.before.style[this.size] = b;
        ...
        onMouseDown: function (a) {
            ...
            this.shiftArrows &&
                (this.btn1.off('.rsaddonbeforeafter'), this.slider.addClass('rs-beforeafter-shift-arrows'));
            this.bounceArrows &&
                (this.bounceDelay && clearTimeout(this.bounceTimer),
        ...
        onMouseUp: function (a) {
            ...
            a &&
                'infinite' === this.bounceArrows &&
                (this.bounceDelay
                    ? (this.bounceTimer = setTimeout(this.delayBounce, this.bounceDelay))
                    : (this.shiftArrows && this.slider.removeClass('rs-beforeafter-shift-arrows'),
            ...
            if (!this.supress && !this.blurred)
                if (this.prevent) this.prevent = !1;
                    ...
                    var c = a.target,
                        ...
                        e;
                    if (!(e = 'A' === a.target.tagName || b.test(c.className)))
                        a: {
                            for (; c.parentNode; )
                    ...
                    e ||
                        ((c = (this.carousel ? this.slide : this.slider).offset()),
                        (b = a.pageX - c.left),
                        (e = a.pageY - c.top),
                        this.normal
                            ? ((c = b),
                              (a = this.sliderWidth),
                              (e = Math.min(this.sliderHeight - this.buffer, Math.max(e, this.buffer))))
                            : ((c = e),
                              (a = this.sliderHeight),
                              (b = Math.min(this.sliderWidth - this.buffer, Math.max(b, this.buffer)))),
                        punchgs.TweenLite.to(this.revealBtn, this.time, { left: b, top: e, ease: this.transition }),
                        (b = { ease: this.transition }),
                        (b[this.size] = a - c),
                        punchgs.TweenLite.to(this.bg, this.time, b),
                        (b = { ease: this.transition }),
                        (b[this.size] = c),
                        punchgs.TweenLite.to(this.before, this.time, b),
                        (b = { ease: this.transition }),
                        (b[this.size] = a - c),
                        punchgs.TweenLite.to(this.after, this.time, b),
                        (b = { ease: this.transition }),
                        (b[this.axis] = c),
                        this.revealLine && punchgs.TweenLite.to(this.revealLine, this.time, b));
                }
        },
        ...
        onComplete: function () {
            ...
            if (this.shiftArrows) {
                if (this.bounceArrows)
                    this.btn1.one(
                        'webkitTransitionEnd.rsaddonbeforeafter transitionend.rsaddonbeforeafter',
                        this.readyArrows,
                    );
                this.slider.addClass('rs-beforeafter-shift-arrows');
            } else this.bounceArrows && this.arrowsReady();
        },
        fade: function () {
            ...
            this.revealLine &&
                punchgs.TweenLite.to(this.revealLine, 0.3, { autoAlpha: 0, ease: punchgs.Power2.easeInOut });
        },
        collapse: function () {
            a = { ease: this.animation };
            a[this.size] = 0;
            punchgs.TweenLite.to(this.bg, this.timing, a);
            var a = { ease: this.animation };
            a[this.size] = '100%';
            punchgs.TweenLite.to(this.before, this.timing, a);
            a = { ease: this.animation };
            a[this.size] = 0;
            punchgs.TweenLite.to(this.after, this.timing, a);
            a = { autoAlpha: 0, ease: this.animation };
            a[this.axis] = '100%';
        ...
        reset: function (a) {
            this.supress = !0;
            this.normal
                ? ((this.revealBtn.style.top = '50%'), (this.revealBtn.style.left = '100%'))
                : ((this.revealBtn.style.top = '100%'), (this.revealBtn.style.left = '50%'));
            ...
            a &&
                (this.shiftArrows && this.slider.removeClass('rs-beforeafter-shift-arrows'),
                this.bounceArrows && this.slider.removeClass('rs-beforeafter-bounce-arrows'));
        },
        playVideo: function () {
        ...
        reveal: function () {
            ...
            if (this.normal) {
                if (c) {
                    var e = (c = a);
                    b = 100 - b + '%';
                } else (a = c = e = b * this.scale), (b = this.sliderWidth - a);
                var g = '50%';
            } else
                c ? ((g = c = a), (b = 100 - b + '%')) : ((a = c = g = b * this.scale), (b = this.sliderHeight - a)),
                    (e = '50%');
            h = { ease: this.animation, delay: this.delay };
            h[this.size] = b;
            this.bg.style.opacity = '1';
            punchgs.TweenLite.to(this.bg, this.timing, h);
            var h = { ease: this.animation, delay: this.delay };
            h[this.size] = c;
        ...
        jQuery('.rev_slider').each(function () {
            ...
            if (e.length) {
                e.each(function () {
                    ...
                    c.data('beforeafter-options', d);
                    if (/html5|youtube|vimeo/.test(d.bgType)) {
                        var f =
                            '<div class="tp-caption tp-resizeme fullscreenvideo disabled_lc tp-videolayer" id="slide-' +
                            c.attr('data-index').replace('rs-', '') +
                            '-layer-0" data-type="video" data-x="[\'0\',\'0\',\'0\',\'0\']" data-y="[\'0\',\'0\',\'0\',\'0\']" data-beforeafter="after" data-basealign="slide" data-responsive_offset="on" data-exitfullscreenonpause="off" data-videocontrols="none" data-videowidth="[\'100%\',\'100%\',\'100%\',\'100%\']" data-videoheight="[\'100%\',\'100%\',\'100%\',\'100%\']" data-videopreload="auto" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" data-autoplay="on" data-frames=\'' +
                            ('[{"delay":"' +
                                (d.carousel ? '10' : 'bytrigger') +
                                '","speed":0,"frame":"0","to":"o:1;","ease":"Linear.easeNone"},{"delay":"wait","speed":0,"frame":"999","ease":"Linear.easeNone"}]') +
                            "' data-textAlign=\"['inherit','inherit','inherit','inherit']\" data-videoloop=\"" +
                            d.loopVideo +
                            '" data-aspectratio="' +
                            d.aspectRatio +
                            '" ';
                        ...
                        d.rewindOnStart && (f += 'data-forcerewind="on" ');
                        ...
                        switch (d.bgType) {
                            ...
                            case 'youtube':
                                if ((g = d.videoId))
                                    (f += 'data-ytid="' + g + '" '),
                                        (f += 'data-videorate="' + d.videoSpeed + '" '),
                                        (f += 'data-videoattributes="' + d.youtubeArgs + '" '),
                                        (f = d.muteVideo
                                            ? f + 'data-volume="mute" '
                                            : f + ('data-volume="' + d.videoVolume + '" ')),
                                        (l = !0);
                                break;
                            case 'vimeo':
                                if ((g = d.videoId))
                                    (f += 'data-vimeoid="' + g + '" '),
                                        (f += 'data-videoattributes="' + d.vimeoArgs + '" '),
                                        (f = d.muteVideo
                                            ? f + 'data-volume="mute" '
                                            : f + ('data-volume="' + d.videoVolume + '" ')),
                                        (l = !0);
                        ...
                        l &&
                            (c.find('.tp-caption').each(z),
                            (l = jQuery(
                                f + 'style="z-index: 5"><div class="rs-fullvideo-cover"></div></div>',
                            ).insertAfter(c.find('.rev-slidebg'))),
                            c.data('beforeafter-video', l));
                    }
                    if (d.hasOwnProperty('bounceArrows')) {
                        c = 0.001 * parseInt(d.bounceSpeed, 10);
                        ...
                        for (var u = 0; 2 > u; u++) {
                            ...
                            a =
                                ...
                                ('@-webkit-keyframes ' +
                                    ...
                                    '-' +
                                    e +
                                    '-rs-beforeafter-bounce-' +
                                    v +
                                    ' {0%, 20%, 50%, 80%, 100% {-webkit-transform: translate' +
                                    l +
                                    '(0);transform: translate' +
                                    l +
                                    '(0)}40% {-webkit-transform: translate' +
                                    l +
                                    '(' +
                                    n +
                                    ...
                                    x +
                                    n +
                                    'px)}60% {-webkit-transform: translate' +
                                    l +
                                    '(' +
                                    r +
                                    'px);transform: translate' +
                                    ...
                                    x +
                                    r +
                                    'px)}}.rs-beforeafter-bounce-arrows .rs-' +
                                    b +
                                    '-' +
                                    e +
                                    '-rs-beforeafter-bounce-' +
                    ...
                    if (d.hasOwnProperty('shiftOffset'))
                        for (
                            c = 0.001 * parseInt(d.shiftTiming, 10), l = 0.001 * parseInt(d.shiftDelay, 10), f = 0;
                            2 > f;
                            f++
                        )
                            (g = d.shiftEasing),
                                (a +=
                                    '.rs-beforeafter-shift-arrows .rs-' +
                                    b +
                                    '-' +
                                    e +
                                    '-rs-beforeafter-shift {-webkit-transition: all ' +
                                    c +
                                    's ' +
                                    g +
                                    ' ' +
